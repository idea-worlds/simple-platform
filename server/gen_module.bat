...
set module_group=-DgroupId=dev.simpleframework
set module_artifact=-DartifactId=%moduleName%
set module_version=-Dversion=0.1-SNAPSHOT
set module_package=-Dpackage=dev.simpleframework.platform.%packageName%
set module_sample=-Dsample=%sampleName%
set module_project=-Dproject=simple-platform
set module_db=-Ddb=postgresql
